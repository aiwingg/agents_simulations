...
class PromptSpecificationManager:
    ...
    def load_specification(self, spec_name: str) -> SystemPromptSpecification:
        ...
        try:
            ...
            self.logger.log_info(f"Loaded prompt specification: {spec_name}", extra_data={
                'spec_name': spec_name,
                'spec_path': spec_path,
            ...
            self.logger.log_error(f"Failed to load prompt specification: {spec_name}", exception=e, extra_data={
                'spec_name': spec_name,
                'spec_path': spec_path
            })
            raise
    ...
    def save_specification(self, spec_name: str, spec_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.logger.log_info(f"Saved prompt specification: {spec_name}", extra_data={
                'spec_name': spec_name,
                'spec_path': spec_path,
                'agents': list(specification.agents.keys()),
                'version': specification.version
    ...
    def delete_specification(self, spec_name: str) -> None:
        ...
        try:
            ...
            self.logger.log_info(f"Deleted prompt specification: {spec_name}", extra_data={
                'spec_name': spec_name,
                'spec_path': spec_path
            })
