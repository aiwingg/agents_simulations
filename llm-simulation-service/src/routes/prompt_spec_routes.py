...
def list_prompt_specifications():
    ...
    try:
        ...
        return jsonify({"specifications": specifications, "total_count": len(specifications)}), 200
...
def update_prompt_specification(spec_name: str):
    ...
    try:
        ...
        return jsonify({"message": "Prompt specification updated successfully", "specification_name": spec_name}), 200
...
def delete_prompt_specification(spec_name: str):
    ...
    try:
        ...
        return jsonify({"message": "Prompt specification deleted successfully", "specification_name": spec_name}), 200
...
def validate_prompt_specification(spec_name: str):
    ...
    try:
        ...
        return jsonify(
            {"valid": False, "issues": [f"Failed to validate: {str(e)}"], "specification_name": spec_name}
        ), 400
...
def duplicate_prompt_specification(spec_name: str):
    ...
    try:
        ...
        return jsonify(
            {"message": "Prompt specification duplicated successfully", "source_name": spec_name, "new_name": new_name}
        ), 201
