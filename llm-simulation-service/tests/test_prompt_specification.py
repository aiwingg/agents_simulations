...
class TestAgentPromptSpecificationFormatting:
    ...
    def test_format_with_variables_basic(self):
        ...
        agent_spec = AgentPromptSpecification(
            name="test_agent", prompt="Hello {{name}}, you are located in {{location}}", tools=["tool1", "tool2"]
        )

        variables = {"name": "John", "location": "New York"}
    ...
    def test_format_with_variables_immutable(self):
        ...
        agent_spec = AgentPromptSpecification(name="test_agent", prompt=original_prompt, tools=["tool1"])
    ...
    def test_format_with_variables_missing_variable(self):
        ...
        agent_spec = AgentPromptSpecification(
            name="test_agent", prompt="Hello {{name}}, you live in {{location}}", tools=[]
        )
    ...
    def test_format_with_variables_no_template(self):
        ...
        agent_spec = AgentPromptSpecification(
            name="test_agent", prompt="This is a static prompt with no variables", tools=[]
        )
    ...
    def test_format_with_variables_complex_template(self):
        ...
        variables = {"name": "John", "location": "NYC", "items": ["apple", "banana", "cherry"]}
...
class TestSystemPromptSpecificationFormatting:
    ...
    def test_format_with_variables_basic(self):
        ...
        agents = {
            "agent1": AgentPromptSpecification(name="agent1", prompt="Hello {{name}}, I'm agent1", tools=["tool1"]),
            "client": AgentPromptSpecification(name="client", prompt="Hi, I'm {{name}} from {{location}}", tools=[]),
        }

        system_spec = SystemPromptSpecification(
            name="test_system", version="1.0", description="Test system", agents=agents
        )
    ...
    def test_format_with_variables_missing_client_agent(self):
        ...
        agents = {"agent1": AgentPromptSpecification(name="agent1", prompt="Hello {{name}}", tools=[])}
    ...
    def test_format_with_variables_agent_formatting_failure(self):
        ...
        agents = {
            ...
            "client": AgentPromptSpecification(name="client", prompt="Hi there", tools=[]),
        }
    ...
    def test_format_with_variables_immutable(self):
        ...
        agents = {
            "agent1": AgentPromptSpecification(name="agent1", prompt=original_agent_prompt, tools=[]),
            "client": AgentPromptSpecification(name="client", prompt="Client prompt", tools=[]),
        }
    ...
    def test_format_with_variables_preserves_handoffs(self):
        ...
        agents = {
            "agent1": AgentPromptSpecification(
                name="agent1", prompt="Hello {{name}}", tools=["tool1"], handoffs={"agent2": "For advanced queries"}
            ),
            "agent2": AgentPromptSpecification(name="agent2", prompt="Advanced agent", tools=["tool2"]),
            "client": AgentPromptSpecification(name="client", prompt="Client prompt", tools=[]),
        }
